...
\acknowledgements{
  ...
  and helped me to overcome various challenges I faced during the development.
...
\keywordsCS{vyvažování a distribuce zátěže, optimalizační algoritmy, Kotlin, Ktor, Docker}
...
\abstractCS{
  ...
  \noindent
  Tato práce se zabývá matematickou formalizací takového problému
  a představuje implementaci plánovače a rozvrhovače zátěže speciálně navrženého a vyvinutého pro optimalizační algoritmy.
}
...
\abstractEN{
  ...
  \noindent
  This work introduced the mathematical formalization 
  and the implementation of the load balancing system specifically designed and developed for the optimization algorithms.
}
