...
Linear optimization (or linear programming) is a method to achieve the best outcome in a mathematical model\todo{I must add more about it since it is an important topic}
...
Even though there are solvers that can provide $\epsilon$ (partial) solution,\todo{this need some reference}
