...
which can receive/handle HTTP requests is registering it within the \inlinecode{Application} context.
...
\begin{algorithm}[H]
	\SetAlgoLined
	\KwInput{Package name, where all routes are stored}
	...
	\KwResult{All routes are registered and ready to use}
\end{algorithm}
\medskip \noindent
